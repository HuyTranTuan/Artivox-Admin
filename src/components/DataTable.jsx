      ...
      <div className="flex items-center gap-1.5">
        ...
        {onViewChange && (
          <div className="flex rounded-xl border border-slate-200 overflow-hidden">
            <Button
              variant="orange"
              className={`h-9 w-9 p-0! flex items-center justify-center transition  ${viewMode === "list" ? "bg-slate-950 text-white" : "text-slate-500 hover:bg-slate-100"}`}
            ...
            <Button
              variant="orange"
              className={`h-9 w-9 p-0! flex items-center justify-center transition  ${viewMode === "grid" ? "bg-slate-950 text-white" : "text-slate-500 hover:bg-slate-100"}`}
