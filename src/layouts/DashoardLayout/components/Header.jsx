    ...
    <header className="sticky top-0 z-30 flex flex-col gap-4 border-b border-slate-200/70 bg-white/70 px-6 py-5 backdrop-blur lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        <div className="relative" ref={notificationRef}>
          <Button
            variant="ghost"
            className="relative h-12 w-12 rounded-2xl p-0"
          ...
          {notificationOpen ? (
            <div
              className="absolute right-0 top-full mt-3 w-80 rounded-2xl border border-slate-200 bg-white px-[5px] py-[5px] shadow-xl"
              style={{ zIndex: 900 }}
            >
        ...
        <div className="relative" ref={menuRef}>
          ...
          {userMenuOpen ? (
            <div
              className="absolute right-0 top-full mt-3 w-52 overflow-hidden rounded-xl border border-slate-200 bg-white px-[5px] py-[5px] shadow-xl"
              style={{ zIndex: 900 }}
            >
              <button
                onClick={() => {
