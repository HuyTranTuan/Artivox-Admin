...
export default function TopStaffByChatRooms({ staff, index }) {
  const { t } = useTranslation();
  return (
    <div key={staff.id || i} className="flex items-center gap-4 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-neutral-800/50 transition">
